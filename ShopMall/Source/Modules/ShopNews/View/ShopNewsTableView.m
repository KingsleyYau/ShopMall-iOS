...
@interface ShopNewsTableView () <RequestImageViewDelegate> {
    
}
@end

@implementation ShopNewsTableView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row < self.items.count) {
        ...
        cell.requestImageView.imageUrl = shopNews.logo.path;
        cell.requestImageView.imageData = shopNews.logo.data;
        cell.requestImageView.contentType = shopNews.logo.contentType;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath  {
    ...
    if (indexPath.row < self.items.count) {
        if([self.tableViewDelegate respondsToSelector:@selector(tableView:didSelectShopNews:)]) {
            [self.tableViewDelegate tableView:self didSelectShopNews:[self.items objectAtIndex:indexPath.row]];
        }
    }
    else {
