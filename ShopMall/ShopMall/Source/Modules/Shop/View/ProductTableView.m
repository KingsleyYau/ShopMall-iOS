...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row < self.items.count) {
        if([self.tableViewDelegate respondsToSelector:@selector(tableView:didSelectProduct:)]) {
            [self.tableViewDelegate tableView:self didSelectProduct:[self.items objectAtIndex:indexPath.row]];
        }
    }
    else {
