...
- (void)setupView {
    ...
    UITapGestureRecognizer *scrollViewDoubleTap = [[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(handleScrollViewDoubleTap:)] autorelease];
    [scrollViewDoubleTap setNumberOfTapsRequired:2];
    [self addGestureRecognizer:scrollViewDoubleTap];
    
    UITapGestureRecognizer *scrollViewTwoFingerTap = [[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(handleScrollViewTwoFingerTap:)] autorelease];
    [scrollViewTwoFingerTap setNumberOfTouchesRequired:2];
    [self addGestureRecognizer:scrollViewTwoFingerTap];
    
    UITapGestureRecognizer *scrollViewSingleTap = [[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(handleScrollViewSingleTap:)] autorelease];
...
- (void)displayImage:(UIImage *)image {
    ...
    UITapGestureRecognizer *doubleTwoFingerTap = [[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(handleDoubleTwoFingerTap:)] autorelease];
