...
- (void)reloadData
{
    ...
    for (int i = 0; i< count; i++) {
        ...
        if (itemPerPage == 9) {
            ...
            [cell.iconButton removeTarget:self action:@selector(actionForItem:) forControlEvents:UIControlEventTouchUpInside];
            [cell.iconButton addTarget:self action:@selector(actionForItem:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)actionForItem:(id)sender
{
    ...
    if([button.superview isKindOfClass:[AWActionSheetCell class]]) {
        AWActionSheetCell* cell = (AWActionSheetCell *)button.superview;
...
//        [[iconView layer] setMasksToBounds:YES];
        ...
        self.iconButton.layer.cornerRadius = 8.0f;
