...
@synthesize kkTextFieldDelegate;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        barItem = [[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(textFieldDoneInput)] autorelease];
        [mutableArray addObject:barItem];
