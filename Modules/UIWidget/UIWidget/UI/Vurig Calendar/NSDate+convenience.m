...
+(NSDate *)dateStartOfWeek {
    ...
    [componentsToSubtract setDay: - ((([components weekday] - [gregorian firstWeekday])
                                      + 7 ) % 7)];
    [componentsToSubtract setTimeZone:[NSTimeZone timeZoneWithAbbreviation:@"GMT"]];
...
+(NSDate *)dateEndOfWeek {
    ...
    [componentsToAdd setTimeZone:[NSTimeZone timeZoneWithAbbreviation:@"GMT"]];
    ...
    NSDateComponents *componentsStripped = [gregorian components: (NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit)
                                                       fromDate: endOfWeek];
    [componentsStripped setTimeZone:[NSTimeZone timeZoneWithAbbreviation:@"GMT"]];
