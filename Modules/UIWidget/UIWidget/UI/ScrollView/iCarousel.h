...
@property (nonatomic, assign) CGFloat perspective;      // 透视点
@property (nonatomic, assign) CGFloat decelerationRate; // 减速[1.0, 0.0], 0.0：全减速(一个个的滑动)
@property (nonatomic, assign) CGFloat scrollSpeed;      // 滑动速度[1.0, 0.0], 1.0：最快
@property (nonatomic, assign) CGFloat bounceDistance;   // 到边缘时回弹[1.0, 0.0], 1.0：最快
@property (nonatomic, assign) BOOL scrollEnabled;       // 是否可以滑动
@property (nonatomic, assign) BOOL bounces;             // 是否可以回弹
